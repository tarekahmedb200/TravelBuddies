...
struct AdminTripDetailsView: View {
    
    @StateObject var viewModel: AdminTripDetailsViewModel
    ...
    var body: some View {
        ...
        ScrollView {
            ...
            VStack(alignment: .leading, spacing: 10) {
                ...
                TripSubDetailsView(tripUIModel: viewModel.tripUIModel,isAdmin:true) {
...
#Preview {
    NavigationStack {
        AdminTripDetailsView(viewModel: AdminTripDetailsFactory(coordinator: TripCoordinator(), tripUIModel: TripUIModel.mockTrips[0]).getAdminTripDetailsViewModel())
    }
}
